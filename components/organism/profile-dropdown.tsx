...
import { History, Lightbulb, LogOut, Settings, User } from "lucide-react";
      ...
      <DropdownMenu onOpenChange={setIsOpen}>
        <div className="group relative">
          ...
          >
            ...
            <DropdownMenuItem render={<button onClick={() => signOut()} className="group flex w-full cursor-pointer items-center gap-3 rounded-xl border border-transparent bg-red-500/10 p-3 transition-all duration-200 hover:border-red-500/30 hover:bg-red-500/20 hover:shadow-sm" type="button" />}><LogOut className="h-4 w-4 text-red-500 group-hover:text-red-600" /><span className="font-medium text-red-500 text-sm group-hover:text-red-600">
                                        Sign Out

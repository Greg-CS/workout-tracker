...
export function Navbar() {
  ...
  return (
    <>
      <header className="fixed top-0 left-1/2 z-50 mt-10 w-[90%] md:w-[50%] -translate-x-1/2 rounded-full border-b border-secondary/20 bg-white/80 backdrop-blur-md dark:border-foreground/10 dark:bg-primary/80">

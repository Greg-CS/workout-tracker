...
export const templates: Template[] = [
  {
    ...
    days: [
      ...
      d(2, "Heavy Pull", [
        ...
        e("DB Hammer Curls", "strength", 3, "10-15 reps", "dumbbells", 90, "No swinging."),
      ...
      d(3, "Legs + Posterior Chain", [
        ...
        e("DB Romanian Deadlift", "strength", 4, "8-12 reps", "dumbbells", 150, "Hinge, don't squat."),
      ...
      d(5, "Push Hypertrophy", [
        ...
        e("DB Lateral Raises", "strength", 3, "12-20 reps", "dumbbells", 75, "Strict reps."),
  ...
  },
  {
    ...
    days: [
      ...
      d(2, "Bench Day", [
        ...
        e("DB Hammer Curls", "strength", 3, "10-15 reps", "dumbbells", 90, "Elbow health."),
      ]),
      d(3, "Recovery", [
